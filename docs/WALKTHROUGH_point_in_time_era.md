...
>
> Current status, live numbers and the full trial ledger: **`PROJECT.md` §15 and §11**.
...
choice, written in plain language. **`PROJECT.md`** holds the mandate, the strategy, the
